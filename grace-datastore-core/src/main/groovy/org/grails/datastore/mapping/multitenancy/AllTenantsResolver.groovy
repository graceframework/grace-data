...
/**
 * For discriminator based multi-tenancy the tenant resolver has to be able to
 * resolve all tenant ids in order to be able to iterate of the the available tenants.
 *
