...
class ConfigurationBuilderSpec extends Specification {
    ...
    void 'Test configuration builder with fallback config'() {
        ...
        when: 'The configuration is built'
        def fallback = new ConnectionSourceSettings().flushMode(FlushModeType.COMMIT).defaults(
                new ConnectionSourceSettings.DefaultSettings().constraints({ -> }))
    ...
    static class TestConfigurationBuilder
            extends ConfigurationBuilder<ConnectionSourceSettings, ConnectionSourceSettings> {
    ...
    static class WithBuilderConfigurationBuilder
            extends ConfigurationBuilder<Config.ConfigBuilder, Config> {
