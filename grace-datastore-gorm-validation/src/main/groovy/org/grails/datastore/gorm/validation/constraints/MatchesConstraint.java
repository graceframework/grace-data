...
public class MatchesConstraint extends AbstractConstraint {
    ...
    public MatchesConstraint(Class<?> constraintOwningClass, String constraintPropertyName,
    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors) {
        if (propertyValue.toString().matches(this.regex)) {
            return;
        }
        ...
        rejectValue(target, errors, ConstrainedProperty.DEFAULT_DOESNT_MATCH_MESSAGE_CODE,
                ...
                new Object[] { constraintPropertyName, constraintOwningClass, propertyValue, this.regex });
    }
