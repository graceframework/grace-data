...
public class MaxConstraint extends AbstractConstraint {
    ...
    public MaxConstraint(Class<?> constraintOwningClass, String constraintPropertyName,
    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors) {
        if (this.maxValue.compareTo(propertyValue) < 0) {
            Object[] args = new Object[] { constraintPropertyName, constraintOwningClass, propertyValue, this.maxValue };
