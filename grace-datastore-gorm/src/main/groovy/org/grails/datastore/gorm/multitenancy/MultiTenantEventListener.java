 ...
 * (ie {@link org.grails.datastore.mapping.multitenancy.MultiTenancySettings.MultiTenancyMode#DISCRIMINATOR}
 *
...
public class MultiTenantEventListener implements PersistenceEventListener {
    ...
    public static final List<Class<? extends ApplicationEvent>> SUPPORTED_EVENTS =
            Arrays.asList(PreQueryEvent.class, ValidationEvent.class, PreInsertEvent.class, PreUpdateEvent.class);
                    ...
                    if (supportsSourceType(datastore.getClass()) && this.datastore.equals(datastore)) {
                        ...
                        if (currentId != null) {
                            try {
                                ...
                                throw new TenantException("Could not assigned tenant id [" + currentId + "] to property [" + tenantId +
                                        "], probably due to a type mismatch. " +
                                        "You should return a type from the tenant resolver that matches the property type of the tenant id!: " +
                                        e.getMessage(), e);
                            }
                        }
                    }
