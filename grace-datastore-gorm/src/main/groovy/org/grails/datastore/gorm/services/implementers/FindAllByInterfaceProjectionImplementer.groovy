 ...
 */
@CompileStatic
class FindAllByInterfaceProjectionImplementer extends FindAllByImplementer
        implements IterableProjectionServiceImplementer<GormEntity>, IterableInterfaceProjectionBuilder {
